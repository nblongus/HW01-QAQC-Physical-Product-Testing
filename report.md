...
![Screenshot - QC Manager - Korean Language](job-market/screenshots/job-01.png)
...
![Screenshot - Trưởng Nhóm QC Đo Kiểm CNC (Kỹ Thuật Viên Giỏi Có Thể Đào Tạo)](job-market/screenshots/job-02.png)
...
![Screenshot - Nhân Viên QC - Thu Nhập Lên Đến 22 Triệu - Hồ Chí Minh](job-market/screenshots/job-03.png)
...
![Screenshot - Trưởng Phòng QA-QC (Tuyển Nam) Thu Nhập 25 Triệu - 30 Triệu](job-market/screenshots/job-04.png)
...
![Screenshot - Tester (QA/QC) - Lĩnh Vực Tài Chính](job-market/screenshots/job-05.png)
...
![Screenshot - Nhân Viên Kiểm Tra Chất Lượng](job-market/screenshots/job-06.png)
...
![Screenshot - QA Engineer — VibeX-Generated Apps (QA QC, Tester)](job-market/screenshots/job-07.png)
...
![Screenshot - QA / QC Intern](job-market/screenshots/job-08.png)
...
![Screenshot - Senior QC (Automation Tester, QA QC)](job-market/screenshots/job-09.png)
...
![Screenshot - Senior Manual Test Engineer (QA/QC)](job-market/screenshots/job-10.png)
...
![Ảnh minh chứng](physical-product/anh-minh-chung.jpg)
...
![ISSUE-01 - TC08 Chức năng hẹn giờ](issues/1.png)

![ISSUE-02 - TC09 Độ phản hồi của bảng điều khiển](issues/2.png)

![ISSUE-03 - TC11 Quạt tản nhiệt sau khi nấu](issues/3.png)

![ISSUE-04 - TC13 Boiling Water Test](issues/4.png)

![ISSUE-05 - TC15 Display Visibility Test](issues/5.png)

| Mã lỗi | Test case liên quan | Mô tả | Mức độ nghiêm trọng | Bằng chứng | Trạng thái |
| --- | --- | --- | --- | --- | --- |
| ISSUE-01 | TC08 | Hẹn giờ có phản hồi nhưng thao tác cài đặt chưa trực quan, người dùng dễ nhầm giữa chỉnh công suất và chỉnh thời gian. | Low | Kết quả thực tế khi thao tác hẹn giờ trên thiết bị | Open |
| ISSUE-02 | TC09 | Bảng điều khiển đôi lúc phản hồi chậm khi nhấn liên tục hoặc khi tay hơi ẩm. | Medium | Video TC09: https://youtube.com/shorts/Rn9ZjYZ-hEQ | Open |
| ISSUE-03 | TC11 | Quạt tản nhiệt sau khi tắt bếp chạy khá lâu và âm thanh dễ gây khó chịu trong không gian nhỏ. | Low | Quan sát trực tiếp sau khi tắt bếp | Open |
| ISSUE-04 | TC13 | Boiling Water Test cho thấy thời gian đun sôi lâu hơn kỳ vọng ở cùng lượng nước thử nghiệm, nhất là khi dùng nồi đáy không thật đều. | Medium | Ghi nhận thời gian đun trong lúc kiểm thử | Open |
| ISSUE-05 | TC15 | Display Visibility Test cho thấy màn hình/đèn hiển thị khó nhìn khi có ánh sáng mạnh chiếu trực tiếp. | Low | Quan sát trực tiếp trong điều kiện ánh sáng mạnh | Open |
...
![Ảnh prompt](physical-product/prompt-test-case.png)
![Ảnh prompt](physical-product/prompt-test-case-1.png)
![Ảnh prompt](physical-product/prompt-test-case-2.png)
![Ảnh prompt](physical-product/prompt-test-case-3.png)
![Ảnh prompt](physical-product/prompt-test-case-4.png)
![Ảnh prompt](physical-product/prompt-test-case-5.png)
![Ảnh prompt](physical-product/prompt-test-case-6.png)
![Ảnh prompt](physical-product/prompt-test-case-7.png)
